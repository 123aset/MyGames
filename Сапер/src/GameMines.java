...
class GameMines extends JFrame {
    ...
    GameMines() {
        ...
        setResizable(false);
        do {
            FIELD_SIZE = Integer.parseInt(JOptionPane.showInputDialog(null, "Кол-во блоков: (Не должно превышать 20)"));
            NUMBER_OF_MINES = Integer.parseInt(JOptionPane.showInputDialog(null, "Кол-во бомб: (Не должно быть меньше: " + FIELD_SIZE * FIELD_SIZE / 4));
        } while (FIELD_SIZE * FIELD_SIZE / 4 > NUMBER_OF_MINES);
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                if (!bangMine && !youWon) {
                    ...
                    if (youWon) {
                        canvas.repaint();
                        timeLabel.stopTimer();
                        int a = JOptionPane.showConfirmDialog(null,"Вы выйграли! Начать еще раз?");
                    ...
                    if (bangMine) {
                        canvas.repaint();
                        timeLabel.stopTimer();
                        int a = JOptionPane.showConfirmDialog(null,"Вы проиграли! Начать еще раз?");
